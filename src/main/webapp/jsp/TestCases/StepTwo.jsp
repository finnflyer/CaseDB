...
<html>
  ...
  <link href="<%=basePath%>css/bootstrap.min.css" rel="stylesheet">
   ...
   <s:hidden  name="caseInfoInstkey"  value="#session.sessionMap['caseInfoInstkey']" />
 	...
 	<div class="row-fluid">
        <div class="col-lg-1">         </div>
 		 <div class="col-lg-10">
            ...
            <s:form action="SaveStepTwo" namespace="/phase4" enctype="multipart/form-data" method="post"  theme="simple">
                			...
                			<s:set value="LanBean" var="langsDB"/>
	     	                 <tr> 
	     	                   <td bgcolor="#FFFF00" align="center">OS</td>
	     	                       <s:iterator value="#langsDB" var='langs' status='st'>
	     	                         <s:if test="#st.index<=16 && #st.index>=2">
	     	                           <td bgcolor="#FFFF00" >
	     	                               ...
	     	                               <s:hidden value="%{#langsDB[#st.index].languageinstkey}" name="lanMap[%{#st.index}].osDes"/>
	     	                           </td>
	     	                         </s:if>
	     	                      </s:iterator>
	                           ...
	                           <s:iterator value="#langsDB" var='langs' status='st'>
	     	                        <s:if test="#st.index<=16 && #st.index>=2">	                
	     	                          <td ><s:select readonly='true' value="%{#langsDB[#st.index].languageinstkey}" list="%{#langsDB}"  cssStyle="width:40px;" listKey='languageinstkey' listValue='lanvalue' name="lanMap[%{#st.index}].localset"  theme="simple"/></td>
	     	                        </s:if>
	     	                      </s:iterator>
	     	                  </tr>
	     	                   <tr> 
