package com.lenovo.ittools.ctd.form;
...
public class TCFormBean {
	...
	private  Map<Integer, String> mapAutomation;
	private  Map<Integer, String> mapLanguage;
	
	//private List<TestCaseFunction> AllFunctionMix=new ArrayList<TestCaseFunction>();
	//private testcaseDAOImpl TCDao;
	...
	public Map<Integer, String> getMapAutomation() {
		return mapAutomation;
	}
	public void setMapAutomation(Map<Integer, String> mapAutomation) {
