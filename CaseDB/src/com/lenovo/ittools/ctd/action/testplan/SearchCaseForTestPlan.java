...
public class SearchCaseForTestPlan extends ActionSupport {
	...
	public String execute() throws Exception{
		...
		if(1==searchflag){
			pageBean = scaseService.findSearchCaseBeanByConditionForPage(hql.toString(), 300, page);
			...
			pageBean = scaseService.findSearchCaseBeanByConditionForPage((String)session.getAttribute("ohql"), 300, page);
			List<SearchCaseBean> list = pageBean.getList();
			for(SearchCaseBean temp:list){
				SearchBeanCatoSetting(temp);
			}
